...
public:
  ...
  LorentzVector gentop_hadronic_v4() const{return m_gentop_hadronic_v4;}
  ...
  std::vector<Particle> genjets_hadronic() const{return m_genjets_hadronic;}
  std::vector<Particle> genjets_leptonic() const{return m_genjets_leptonic;}
  ...
  void set_gentop_hadronic_v4(LorentzVector x) {m_gentop_hadronic_v4=x;}
  ...
  void set_genjets_hadronic(std::vector<Particle> x) {m_genjets_hadronic=x;}
  void set_genjets_leptonic(std::vector<Particle> x) {m_genjets_leptonic=x;}
...
private:
  ...
  LorentzVector m_gentop_hadronic_v4;
  std::vector<Particle> m_jets_hadronic;
  std::vector<Particle> m_jets_leptonic;
  std::vector<Particle> m_genjets_hadronic;
  std::vector<Particle> m_genjets_leptonic;
