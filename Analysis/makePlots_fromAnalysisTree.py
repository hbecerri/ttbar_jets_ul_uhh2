...
_fileDir ="/nfs/dust/cms/user/hugobg/output_UL/muon/"
...
histograms = {
              ...
              "M_tt": ["Mttbar", "Events", 20, [700, 4000]], 
              ...
              "M_tl": ["Mass_{t_{h}}", "Events", 40, [120,220]],
              "M_th": ["Mass_{t_{l}}", "Events", 40, [120,220]],
...
#
sample_names = ["QCD_HT_2016", "DYJetsToLL_M-50_HT_2016", "ST_2016", "WJetsToLNu_2016", "TTToSemiLeptonic_2016"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"weight*(M_tt > 700 & Mu_pt > 73 & chi2 < 100)")
...
tree.Draw("%s>>dat_hist(%i,%i,%f)"%(histName,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"M_tt > 700  & Mu_pt > 73  & chi2 < 100")
